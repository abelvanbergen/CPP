...
/*   Updated: 2021/05/06 14:16:13 by avan-ber      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->_Type << " <" << this->_Name << "> attacks " << target << " with his kalisticks causing " << this->_RangedAttackDamage << " point of damage!" << std::endl;
	return ;
}
