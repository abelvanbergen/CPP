...
/*   Updated: 2021/03/01 17:35:24 by avan-ber      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->_Type << " <" << this->_Name << "> attacks " << target << " at range causing " << this->_RangedAttackDamage << " point of damage!" << std::endl;
	return ;
}
...
{
	std::cout << "Fr4G-TP was created out of sawdust" << std::endl;
	_Hp = 100;
	_Max_Hp = 100;
	_Ep = 100;
	_Max_Ep = 100;
